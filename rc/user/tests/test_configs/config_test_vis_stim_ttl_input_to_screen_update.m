...
config.nidaq.ai.channel_names           = {'filtered_teensy', 'ttl_to_vis_stim_computer', 'stage', 'lick', 'pump', 'solenoid', 'photodiode', 'minidaq_ao0', 'multiplexer_output'};
% 
...
if config.use_calibration_file
    ...
    config.nidaq.ai.offset                  = [0.5, 0, 0, 0, 0, 0, 0, 0, 0]; % 
    config.nidaq.ai.scale                   = [40, 1, -40, 1, 1, 1, 1, 1, 1];
end
