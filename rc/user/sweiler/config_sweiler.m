...
config.lick_detect.detection_window_is_triggered = 0;  % 0 = rewards given on lick detection, 1 = rewards given in window after trigger rise detected, 2 = rewards given when trigger is high
