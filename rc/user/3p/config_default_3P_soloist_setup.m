function config = config_default_3P_soloist_setup()
...
config.nidaq.ai.channel_names           = {'camera', 'scanimage_frameclock', 'photodiode1', 'photodiode2', 'grab_start', 'filtered_teensy', 'stage', 'solenoid'};
% 
config.nidaq.ai.channel_id              = [0:7];
config.nidaq.ai.offset                  = [0, 0, 0, 0, 0, 0.5, 0, 0]; % 
config.nidaq.ai.scale                   = [1, 1, 1, 1, 1, 40, 40, 1];
