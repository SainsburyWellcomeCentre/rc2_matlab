classdef WaveformPeak_DoubleRotation < handle
    ...
    methods
        function obj = WaveformPeak_DoubleRotation(ni, config)
            ...
            obj.enabled = config.waveformpeak_trigger.enable;
            ...
            this_name = config.waveformpeak_trigger.do_name;
            obj.chan = find(strcmp(this_name, all_channel_names));
            % Set the state variable
            obj.state = config.waveformpeak_trigger.init_state;
        end
