...
analysis.bin_fname = 'C:\Users\Margrie_Lab1\Documents\raw_data\CAA-1123583\CAA-1123583_t28_ContrastTraining_Stage2.bin';
...
% latency
analysis.timestamp.trigger = sort(analysis.timestamp.trigger);
...
for i = 1:analysis.output.n_trials
    analysis.latencytable.stimulus_type{1,i} = analysis.online_data.stimulus_type{analysis.temp.typeididx(i)};
    analysis.latencytable.latency(1,i) = analysis.trial.latency(analysis.temp.typeididx(i));
end
splus_type = analysis.latencytable.stimulus_type(1:analysis.output.n_trials/2); splus_type=splus_type';
sminus_type = analysis.latencytable.stimulus_type(analysis.output.n_trials/2+1:end);sminus_type=sminus_type';
latency_splus = analysis.latencytable.latency(1:analysis.output.n_trials/2);latency_splus=latency_splus';
latency_sminus = analysis.latencytable.latency(analysis.output.n_trials/2+1:end);latency_sminus=latency_sminus';
