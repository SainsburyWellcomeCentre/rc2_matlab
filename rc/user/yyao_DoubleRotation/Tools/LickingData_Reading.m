...
try
    idx.photodiodeR_idx             = strcmp(channel_names, 'photodiode_right'); 
    idx.latency_chan_idx               = strcmp(channel_names, 'latency_trigger');
catch
end 
...
try
    signal.photodiodeR_signal      = data(:, idx.photodiodeR_idx);             
    signal.latency_signal          = data(:, idx.latency_chan_idx);        
catch
end
