function [protocolconfig,seq] = ContrastTraining_Stage1(ctl,config,view)
    ...
    protocolconfig.reward.duration = floor(config.reward.splusduration/((n_s_plusL_trials+n_s_plusR_trials)*n_blocks));
