function seq = passive_protocol_motion_clouds(ctl)

load('passive_protocol_sequence_motion_clouds.mat', 'trial_order', 'protocol_id', 'fnames');
...
%       vest_with_flow
%       vest_darkness (in fact, visual static Tvs)
%       visual_flow
