...
The main configuration file is in %TOP_DIR%\rc\main\load_config.m, where TOP_DIR is the location on the system of the rc2_matlab directory. This file should contain most of the configuration variables for a day to day basis.
