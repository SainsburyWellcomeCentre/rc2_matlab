...
g++ -o "..\exe\listen_position.exe" listen_position.c rc_shared.c -L"C:/Program Files (x86)/Aerotech/Soloist/CLibrary/Lib64" -lSoloistC64
...
g++ -o "..\exe\calibrate_zero_no_gear.exe" calibrate_zero_no_gear.c rc_shared.c -L"C:/Program Files (x86)/Aerotech/Soloist/CLibrary/Lib64" -lSoloistC64
g++ -o "..\exe\mismatch_ramp_down_at.exe" mismatch_ramp_down_at.cpp rc_shared.c -L"C:/Program Files (x86)/Aerotech/Soloist/CLibrary/Lib64" -lSoloistC64
g++ -o "..\exe\mismatch_ramp_up_until.exe" mismatch_ramp_up_until.cpp rc_shared.c -L"C:/Program Files (x86)/Aerotech/Soloist/CLibrary/Lib64" -lSoloistC64
echo done